...
export const CanvasStageGrid = styled.div<{ width: number }>`
  margin-top: 40px;
  display: grid;
  grid-template-columns: 50px ${({ width }) => width}px 50px;
`

export const CanvasStageTop = styled.div<{ width: number }>`
...
export const CanvasStageBottom = styled.div<{ width: number }>`
  width: ${({ width }) => width}px;
  height: 50px;
  border: 1px solid ${borderColor};
  box-sizing: border-box;
...
export const CanvasStageLeft = styled.div<{ height: number }>`
  margin-top: 50px;
  width: 50px;
...
export const CanvasStageRight = styled.div<{ height: number }>`
  margin-top: 50px;
  width: 50px;
  height: ${({ height }) => height}px;
  border: 1px solid ${borderColor};
...
export const CanvasStageMiddle = styled.div<{ width: number; canvasWidth: number }>`
  display: grid;
  grid-template-columns: repeat(${({ canvasWidth }) => canvasWidth}, ${({ width }) => width}px);
`

export const CanvasLayer = styled.div<{ width: number; height: number; showGrid: boolean }>`
  width: ${({ width }) => width}px;
  height: ${({ height }) => height}px;
  box-sizing: border-box;
  position: relative;
...
export const LayerVotingButtons = styled.div`
  display: grid;
...
export const CanvasVoting = styled.div``

export const LayerVotingImg = styled.img``
